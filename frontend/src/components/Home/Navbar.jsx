      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <button 
              onClick={() => navigate('/howWork')}
              className="text-gray-700 cursor-pointer hover:text-purple-600  font-medium flex items-center space-x-1.5"
            >
            ...
            <button 
              ...
              className="cursor-pointer text-gray-700 hover:text-purple-600 font-medium flex items-center space-x-1.5"
            >
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <button 
              ...
              className="cursor-pointer px-5 py-2.5 bg-gradient-to-r from-amber-500 to-orange-400 text-white font-medium hover:from-amber-600 hover:to-orange-500 rounded-full transition-colors"
            >
              Get Started
            </button>
          </div>
          ...
          <div className="md:hidden">
            <button
              ...
              className="cursor-pointer p-2 rounded-lg hover:bg-gray-100 text-gray-600"
            >
      ...
      {isMenuOpen && (
        <div className="md:hidden absolute w-full bg-white border-t">
          <div className="px-5 pt-4 pb-6 space-y-4">
            ...
            <a className="cursor-pointer block p-3 rounded-lg hover:bg-gray-50 font-medium text-gray-700">
              How It Works
            </a>
            <a onClick={()=>navigate("/browse")} className="cursor-pointer block p-3 rounded-lg hover:bg-gray-50 font-medium text-gray-700">
              Browse Coupons
            </a>
            <button 
              onClick={() => navigate('/sell')}
              className="cursor-pointer block p-3 rounded-lg bg-purple-50 text-purple-600 font-medium w-full text-left"
            >
              Sell Coupons
            </button>
            <div className="pt-4 space-y-3">
              <button className="cursor-pointer w-full py-2.5 text-center text-purple-600 font-medium border border-purple-600 rounded-full">
                Sign In
              </button>
              {/* Mobile Get Started Button */}
              <button 
                onClick={() => navigate('/dashboard')}
                className="cursor-pointer w-full py-2.5 text-center text-white bg-purple-600 font-medium rounded-full hover:bg-purple-700"
              >
                Get Started
              </button>
            </div>
